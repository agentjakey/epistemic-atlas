...
**Prototype:** Next.js interactive prototype with two fully structured case studies
...
- Nine-step pipeline with prompt templates (prompts/01 through prompts/09)
